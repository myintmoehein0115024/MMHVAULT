...
(()=>{
  ...
  const bp=buffer(gl.ARRAY_BUFFER,new Float32Array(P)),bn=buffer(gl.ARRAY_BUFFER,new Float32Array(N)),bu=buffer(gl.ARRAY_BUFFER,new Float32Array(U)),bi=buffer(gl.ELEMENT_ARRAY_BUFFER,new Uint16Array(I));
