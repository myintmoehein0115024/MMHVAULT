...
(()=>{
  ...
  const satSpecs=[
    {orbit:orbitEls[0],cls:'arch65-satellite arch65-sat-cyan',phase:.15,speed:.55},
    {orbit:orbitEls[0],cls:'arch65-satellite arch65-sat-cyan',phase:3.35,speed:.55},
    {orbit:orbitEls[1],cls:'arch65-satellite arch65-sat-gold',phase:1.2,speed:-.42},
    {orbit:orbitEls[1],cls:'arch65-satellite arch65-sat-gold',phase:4.55,speed:-.42},
    {orbit:orbitEls[2],cls:'arch65-satellite arch65-sat-cyan',phase:2.2,speed:.34}
  ];
  ...
  orbitEls.forEach(el=>el.style.setProperty('--v7-no-pseudo','1'));
    ...
    if(sv&&sf){
      ...
      if(gl.getProgramParameter(pr,gl.LINK_STATUS)){
        ...
        const frame=ms=>{
          ...
          if(!paused){
            if(motionOK){ earthAngle += dt*0.00042; orbitAngle += dt*0.00092; }
